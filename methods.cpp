...
void getDatas(int& n, double& r, int& maxIter, int& numberOfInc)
{
  ...
  std::cout << "Number of iterations wanted ? " << std::endl;
  std::cin >> maxIter;

  std::cout << "Number of iterations before incrementation? " << std::endl;
  std::cin >> numberOfInc;
}
